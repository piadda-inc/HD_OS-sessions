...
This basically means I physically cannot use tools that modify state until you agree with what I'm proposing (Write, Edit, Bash commands that modify files, etc.)
