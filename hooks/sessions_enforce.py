...
if tool_name == "Bash" and STATE.mode is Mode.NO and not STATE.flags.bypass_mode:
    ...
    if not is_bash_read_only(command):
        ...
        print(f"[DAIC] Blocked write-like Bash command in Discussion mode. Only the user can activate orchestration mode. Explain what you want to do and seek alignment and approval first.\n"
